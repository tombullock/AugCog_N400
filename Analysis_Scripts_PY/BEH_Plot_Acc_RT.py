...
image_title = 'Behavior' # destination figure title 
...
ax3 = plt.subplot2grid((fig_h, fig_w), (0, 9), rowspan = 5, colspan=6) # axis for RT boxplot + beeswarm plot
